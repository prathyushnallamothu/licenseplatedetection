...
def main(img_path=None, vid_path=None, vid_out=None):
    ...
    model = torch.hub.load('./yolov5', 'custom', source='local',
                           path='best.pt', force_reload=True)  # The repo is stored locally
...
#main(vid_path=0,vid_out="webcam_licence_result.mp4") #### for webcam

main(img_path="./data/images/test/Cars252.png")  # for image
